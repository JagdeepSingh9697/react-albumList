//all the necessary imports for the add new album button functionality function
...
export default Radium(function AddNewAlbum(props) {
    ...
    //styling for the add new album button
    const style = {
        addNewAlbumButton: {
            "height": "300px",
            "width": "300px",
            ...
            ':hover': {
                ...
                "background": "linear-gradient(to bottom, rgb(46, 44, 40), rgb(85 97 176))",
                "color": "white"
            }
        },
    ...
    //function to handle the on button click of the modal
